...
class EfiPayPrestashopRedirectopenfinanceModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        if (isset($_GET['identificadorPagamento'])) {
            ...
            $charge_data = dbEfiPayPrestaShop::getChargeDataByIdCharge($identificadorPagamento);

            http_response_code(200);
            header('Location: ' . $charge_data);
            exit;
        } else {
